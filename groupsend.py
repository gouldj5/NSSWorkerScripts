...
# Description   - Sends the same command to all tabs that currently have an active connection.
...
def Main():
    ...
    for command in range(1,500):
	    ...
	    # something wrong.
	    #response = crt.Dialog.MessageBox("Are you sure you want to send the following command to __ALL__ tabs?\n\n" + command,
	    ...
	    # Activate the original tab and increment for loop
	    initialTab.Activate()
	   ...
	   # crt.Dialog.MessageBox("The following command was sent to all connected tabs:\n\t" + command + skippedTabs)
